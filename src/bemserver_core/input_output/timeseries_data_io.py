...
class TimeseriesDataIO:
    ...
    @classmethod
    def get_timeseries_buckets_data_combined(
        cls,
        start_dt,
        end_dt,
        timeseries,
    ...
    @classmethod
    def get_timeseries_buckets_data_device(
        cls,
        start_dt,
        end_dt,
        timeseries,
    ...
    @classmethod
    def get_timeseries_aggregate_by_device_category(
        cls,
        start_dt,
        end_dt,
        timeseries,
...
class TimeseriesDataJSONIO(TimeseriesDataIO, BaseJSONIO):
    ...
    @classmethod
    def export_json_bucket_combined(
        cls,
        start_dt,
        end_dt,
        timeseries,
        ...
        *,
        ...
        See ``TimeseriesDataIO.get_timeseries_buckets_data``.
        """
        data_df = cls.get_timeseries_buckets_data_combined(
            start_dt,
            end_dt,
            timeseries,
            data_state,
    ...
    def export_json_bucket_combined_device(
        ...
        *,
        ...
        See ``TimeseriesDataIO.get_timeseries_buckets_data``.
        """
        data_df = cls.get_timeseries_buckets_data_device(
            start_dt,
            end_dt,
            timeseries,
            data_state,
    ...
    def export_json_aggregate_by_device_category(
        ...
        *,
        ...
        See ``TimeseriesDataIO.get_timeseries_buckets_data``.
        """
        data_df = cls.get_timeseries_aggregate_by_device_category(
            start_dt,
            end_dt,
            timeseries,
            data_state,
